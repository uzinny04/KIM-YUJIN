...
> 전기공학적 설계 능력과 생체신호 해석 역량을 바탕으로 임피던스 기반 바이오센서 및 진단 시스템 연구를 수행합니다.
...
- 10mL 고용량 시료 전처리 구현 → 기존 대비 5배 처리량 향상
- 장치 설계, 시제품 제작, 성능 측정, 데이터 분석까지 **전 과정 주도**

🏅 *2025 마이크로나노시스템학회 추계학술대회 우수상 수상*  
...
| 연도 | 수상명 | 주관 | 내용 |
|------|--------|------|------|
| 2026 | **장려상** | 마이크로나노시스템학회 |  |
| 2025 | **우수상** | 마이크로나노시스템학회 |  |
